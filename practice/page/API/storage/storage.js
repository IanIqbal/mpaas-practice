Page({
    ...
    if (key.length === 0) {
      ...
      my.setStorage({
        ...
        success() {
          ...
          my.alert({
            title: 'Successfully stored data',
            content: `${key}: ${data}`,
          });
        },
      });
  ...
  setStorageSync() {
    ...
    if (key.length === 0) {
      ...
      if (!res.error) {
        ...
        my.alert({
          title: 'Synchronization of stored data succeeded',
          content: `${key}: ${data}`,
        });
      }
    }
  ...
  removeStorageSync() {
    ...
    if (!res.error) {
      ...
      my.alert({
        title: 'Successfully deleted data synchronously',
        content: '',
      });
    }
  },
  clearStorageSync() {
    ...
    if (!res.error) {
      ...
      my.alert({
        title: 'Successfully cleared data synchronously',
        content: '',
      });
    }
  },
